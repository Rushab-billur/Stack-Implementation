...
void flowchart() {
  ...
  glColor3f(0, 0, 0);
  println(55, 350, 0, GLUT_BITMAP_TIMES_ROMAN_24, "PUSH");
  ...
  println(48, 180, 0, GLUT_BITMAP_TIMES_ROMAN_24, "(top>=n)");
  glBegin(GL_LINE_LOOP);
  glVertex2f(60, 220);
  glVertex2f(25, 185);
  glVertex2f(60, 150);
  ...
  println(333, 350, 0, GLUT_BITMAP_TIMES_ROMAN_24, "POP");

  println(330, 325, 0, GLUT_BITMAP_TIMES_ROMAN_24, "START");
  glBegin(GL_LINE_LOOP);
  glVertex2f(320, 340);
  glVertex2f(320, 320);
  glVertex2f(360, 320);
...
void first_page() {
  ...
  glLoadIdentity();
  glColor3f(0, 0, 1);
  println(130.0, 370.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24,
  ...
  glColor3f(1, 0.5, 0);
  println(99.0, 330.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24,
  ...
  println(25.0, 80.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24,
          "PRATEEK K      (4SU19CS068)");

  glColor3f(0.9, 0.4, 0.5);
  println(25.0, 60.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24,
          "RUSHAB BILLUR  (4SU19CS077)");

  glColor3f(1, 0.5, 0);
  println(330.0, 120.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "GUIDE:");
  println(330.0, 120.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "______");

  glColor3f(0.9, 0.4, 0.5);
  println(300.0, 100.0, 0.0, GLUT_BITMAP_TIMES_ROMAN_24,
          "Dr.Raghavendra Patil G.E");
...
void ABOUT() {
  ...
  println(90.0, 290.0, 1.0, GLUT_BITMAP_TIMES_ROMAN_24,
          " 3) Stack has one pointer called TOP .");
  ...
  glColor3f(0.0f, 0.0f, 0.0f);
  println(50.0, 100.0, 1.0, GLUT_BITMAP_TIMES_ROMAN_24, " 1)PUSH:- ");

  glColor3f(0.0f, 0.0f, 0.0f);
  println(85.0, 100.0, 1.0, GLUT_BITMAP_TIMES_ROMAN_24,
          " It is used to insert an element . ");

  glColor3f(0.0f, 0.0f, 0.0f);
  println(50.0, 80.0, 1.0, GLUT_BITMAP_TIMES_ROMAN_24, " 2)POP   :- ");
